...
const AnotherWayOfCounter = observer(function Counter() {

    const { counterStore } = useStore();
    return (
        <>
            <Typography variant="h4" gutterBottom>Another Way Of Counter</Typography>
...
export default AnotherWayOfCounter;